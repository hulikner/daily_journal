...
import { getPosts, usePostCollection, getSinglePost, updatePost, deletePost, logoutUser, getLoggedInUser, setLoggedInUser, postLike, loginUser, registerUser } from "./JournalData.js";
...
document.addEventListener("click", (event) => {
  ...
  if (event.target.id.startsWith("updatePost")) {
    ...
    const entry = document.querySelector("[name='journalEntry']").value;
